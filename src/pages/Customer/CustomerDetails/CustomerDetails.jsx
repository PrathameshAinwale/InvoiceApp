    ...
    return (
      <div className="cd-page page">
        <div className="cd-header">
          ...
          <h2 className="cd-title">Customer Not Found</h2>
        </div>
      </div>
    );
  }
    ...
    <div className="cd-page page">
      ...
      <div className="cd-stats">
        <div className="cd-stat-card">
          <p className="cd-stat-label">Total Invoices</p>
          <p className="cd-stat-value">{customer.totalInvoices}</p>
        </div>
        <div className="cd-stat-card">
          <p className="cd-stat-label">Total Amount</p>
          <p className="cd-stat-value">₹{customer.totalAmount.toLocaleString()}</p>
        </div>
        <div className="cd-stat-card">
          <p className="cd-stat-label">Category</p>
      ...
      <div className="cd-invoices-section">
        <div className="cd-invoices-header">
          ...
          <h3 className="cd-invoices-title">Invoice History</h3>
        </div>
